...
CHANNEL_USERNAME = "@FEEDBACKDDOSS"
...
def handle_attack(message):
    ...
    if is_attack_running(user_id):
        bot.reply_to(message, "⚠️ **𝐑𝐔𝐊 𝐁𝐄 𝐁𝐇𝐀𝐈, 𝐄𝐊 CHUDAI 𝐂𝐇𝐀𝐋 𝐑𝐇𝐀 𝐇𝐀𝐈!** ⚡")
        return
    ...
    if user['attacks'] >= ATTACK_LIMIT:
        bot.reply_to(message, f"❌ **CHUDAI 𝐋𝐈𝐌𝐈𝐓 𝐎𝐕𝐄𝐑!** ❌\n🔄 *𝐓𝐑𝐘 𝐀𝐆𝐀𝐈𝐍 𝐓𝐎𝐌𝐎𝐑𝐑𝐎𝐖!*")
        return
...
def send_attack_finished(message, user_name, target, port, time_duration, remaining_attacks):
    ...
    bot.send_message(message.chat.id, "🚀 **𝐍𝐄𝐗𝐓 CHUDAI 𝐑𝐄𝐀𝐃𝐘!** ⚡")
...
def handle_screenshot(message):
    ...
    try:
        ...
        if user_status not in ['member', 'administrator', 'creator']:
            bot.reply_to(message, f"❌ **𝐘𝐨𝐮 𝐌𝐔𝐒𝐓 𝐉𝐎𝐈𝐍 𝐎𝐔𝐑 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 𝐅𝐈𝐑𝐒𝐓!**\n"
                                  f"🔗 **𝐉𝐨𝐢𝐧 𝐇𝐞𝐫𝐞:** [Click Here](@TITANOFFICIALREAL{CHANNEL_USERNAME})")
            return  
    ...
    if pending_feedback.get(user_id, False):
        ...
        bot.reply_to(message, "✅ **𝐅𝐄𝐄𝐃𝐁𝐀𝐂𝐊 𝐀𝐂𝐂𝐄𝐏𝐓𝐄𝐃! 𝐍𝐄𝐗𝐓 CHUDAI 𝐑𝐄𝐀𝐃𝐘!** 🚀")
    else:
