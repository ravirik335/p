...
current_attack = None
attack_history = [] 
TELEGRAM_BOT_TOKEN = '7797311911:AAFJz9xwyVTzA6522PZ22mdvnaiTHzusv8E:'
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        "*🎉 Welcome to the MEXDEVELOPER Ultimate UDP Flooder! 🎉*\n\n"
...
async def attack(update: Update, context: CallbackContext):
    ...
    if user["coins"] < COINS_REQUIRED_PER_ATTACK:
        await context.bot.send_message(
            chat_id=chat_id,
            text="*💰 Insufficient coins! Please contact the admin to acquire more coins. DM: @MEXDEVELOPER*",
            parse_mode='Markdown'
        )
        return
...
async def help(update: Update, context: CallbackContext):
    chat_id = update.effective_chat.id
    message = (
        "*🛠️ MEXDEVELOPER VIP DDOS Bot Help Menu 🛠️*\n\n"
        ...
        "- *If you encounter any issues, contact the admin: @MEXDEVELOPER*\n\n"
